...
public class ClienteResource {
	...
	public ResponseEntity<List<ClienteDTO>> findAll() {
		...
		List<ClienteDTO> listDto = categorias.stream().map(categoria -> new ClienteDTO(categoria)).collect(Collectors.toList());
	...
	public ResponseEntity<Page<ClienteDTO>> findPage(
		...
		Page<ClienteDTO> listDto = categorias.map(categoria -> new ClienteDTO(categoria));
